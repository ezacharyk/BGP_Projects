...
/**
 * This is a major departure from the simple Main.hx files you ahve seen so far.
 * In this implimentation, we are doing some extra work to zoom in the screen from our game's resolution of 320x180
 * to a doubled size of 640x360. We do this mainly to keep the resources small but make them easier to view.
 */
